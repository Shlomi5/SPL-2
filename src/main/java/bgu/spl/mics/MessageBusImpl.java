...
<<<<<<<< Updated upstream:src/src/main/java/bgu/spl/mics/MessageBusImpl.java
...
========
			...
			wait(500); // Wait until a message is added
>>>>>>>> Stashed changes:src/main/java/bgu/spl/mics/MessageBusImpl.java
		}
